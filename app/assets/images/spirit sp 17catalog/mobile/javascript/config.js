...
bookConfig.macBookVersion = "MAceuuEJYTvvNETcqjHMQforAEcdouCOSSksLHfQrnOCbZtrJEbQjhHJZWknDFQUvnAMXbguOAZfsvAIdYruOIfapq3aD31E22_";
bookConfig.Html5Template = "Metro";
bookConfig.searchTextJS="javascript/search_config.js";
bookConfig.totalPageCount=33;
bookConfig.largePageWidth=1200;
bookConfig.largePageHeight=776;
bookConfig.bookTitle="Demo";
bookConfig.normalPath="../files/mobile/";
bookConfig.largePath="../files/mobile/";
bookConfig.productName="Flip PDF";
bookConfig.MidBgColor="#21ba21";
bookConfig.bookmarkCR = "d42ea9dea2852a3ccf34816de287c55314af94c7";
